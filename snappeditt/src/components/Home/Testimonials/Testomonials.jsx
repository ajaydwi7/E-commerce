...
const TestimonialSection = () => {
  const testimonials = [
    ...
    },
    {
      img: AvatarMan,
      quote:
        "Snapp Editt have been amazing. I send them basic, unprocessed images of my clients' property, and in a quick time span they return exquisitely retouched images that really improve the look of my real estate listings.",
      name: "Russell",
    ...
    <section className="testimonial-section">
      ...
      <div className="testimonial-container">
        ...
        <div className="navigation-arrows">
          <button className="nav-arrow prev-arrow" onClick={handlePrevious} aria-label="Previous testimonial">
            &#10094;
          </button>
