...
function CategoryManagement() {
  ...
  const handleAddSubcategory = async (subcategoryData) => {
    try {
      const response = await fetch(`/api/categories/${subcategoryData.categorySlug}/subcategories`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleUpdateSubcategory = async (subcategoryData) => {
    try {
      const response = await fetch(
        `/api/categories/${subcategoryData.categorySlug}/subcategories/${editingSubcategory.slug}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDeleteSubcategory = async (category, subcategory) => {
    if (
      window.confirm(
        `Are you sure you want to delete ${subcategory.name}? This will also delete all services within this subcategory.`,
      )
    ) {
      try {
        const response = await fetch(`/api/categories/${category.slug}/subcategories/${subcategory.slug}`, {
          method: "DELETE",
        })
